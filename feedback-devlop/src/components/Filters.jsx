...
function Filters() {
 ...
 const [statusChecked, setStatusChecked] = useState(0)
  ...
  const onSubmitHandler = (e)=>{
    ...
    if(statusFilter){
      isPublished = statusFilter === 'pending' ? false : true
    }
    console.log(categoryFilter,statusFilter);
    fetchFeedback(1,categoryFilter,isPublished)
  ...
  return (
    ...
    <h3>Status filter</h3>
    <div className="radio">
    <input key="pending" onClick={(e)=>handleStatusFilterChange(e,0)} label="All" type="radio"  name="status_filter" value="All" checked={statusChecked === 0} />
